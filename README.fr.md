...
Une part croissante des recherches ne passe plus par Google. Un acheteur B2B demande directement à ChatGPT ou Claude *"quel est le meilleur outil SEO pour une petite entreprise ?"* et reçoit trois noms. Pas de page de résultats, pas de classement, pas de deuxième page.

Pour une marque, ça pose une question à laquelle le SEO classique ne répond pas : **suis-je citée dans ces réponses, à quelle fréquence, et est-ce que ça change selon le modèle interrogé ou la langue utilisée ?**

Aujourd'hui, cette question se traite surtout par captures d'écran : on pose la question une fois, on regarde la réponse. Ce n'est pas une mesure, c'est un tirage au sort. Ce projet construit un pipeline reproductible pour la mesurer correctement, le **Generative Engine Optimization (GEO)** / **Answer Engine Optimization (AEO)** appliqué à un marché réel et vérifiable : les 11 principaux **outils SEO & content** du marché B2B (Semrush, Ahrefs, Moz, et 8 autres).
...
**Mesurer un seul modèle ne suffit pas.** SE Ranking est citée dans près d'une réponse sur deux par Claude, et quasiment jamais par GPT. Une marque qui n'auditerait que ChatGPT se croirait invisible alors qu'elle est très présente ailleurs, ou l'inverse.

**Une visibilité en anglais ne se transpose pas en français.** Moz perd 14 points de fréquence de citation entre les deux langues, avec un écart statistiquement significatif. Pour une marque qui s'internationalise, la visibilité générative se mesure marché par marché.

**Une seule requête ne prouve rien.** Les réponses varient d'un appel à l'autre. Sans répétition et sans intervalle de confiance, une capture d'écran ne dit pas si une marque est réellement citée ou si c'était un coup de chance.

**Périmètre assumé :** cet outil mesure, il ne prescrit pas. Il dit où en est une marque dans les réponses génératives à un instant donné. Il ne dit pas quoi faire pour améliorer ce score. Mesurer juste avant d'optimiser.
...
**À propos :** projet construit en autonomie pour mesurer un phénomène que le marketing digital commence tout juste à documenter. Le code et la méthodologie complète sont ouverts, questions et retours bienvenus.

Nada Chniter, Cheffe de projet digital · [LinkedIn](https://www.linkedin.com/in/nada-chniter/)
