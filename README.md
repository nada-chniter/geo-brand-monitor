...
Search is changing. People increasingly ask ChatGPT or Claude "what's the best SEO tool for a small business?" instead of typing the same query into Google. For any B2B brand, that shift raises a new question traditional SEO can't answer: **how often does a given LLM cite your brand, in what context, and can you even measure that reliably?**

This project builds a small, reproducible pipeline to measure that **Generative Engine Optimization (GEO)** / **Answer Engine Optimization (AEO)**  applied to a real, verifiable market: **SEO & content tools** (Semrush, Ahrefs, Moz, and 8 other B2B players).
